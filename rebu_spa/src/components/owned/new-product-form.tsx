...
export function NewProductForm({
  ...
  const isValid =
    name &&
    name.trim() && // Check if name is truthy before trimming
    desc &&
    desc.trim() && // Check if desc is truthy before trimming
    category &&
    category.trim() && // Check if category is truthy before trimming
    price &&
    imagePreviews.length > 0 &&
    digitalFile;
